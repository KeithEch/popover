# Handoff: Asset & Color Library Popover

## Overview
A single modal popover, 692px wide, that appears over an app canvas and lets a user browse and manage
library items. It has two versions sharing one shell:
